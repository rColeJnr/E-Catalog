...
import com.rick.book.screen_book.gutenberg_search.databinding.BookScreenBookGutenbergSearchGutenbergEntryBinding
...
class SearchViewHolder(
    binding: BookScreenBookGutenbergSearchGutenbergEntryBinding,
...
//    }
    ...
    fun bind(book: UserGutenberg) {
        ...
        this.authors.text = resources.getString(
            R.string.book_screen_book_gutenberg_search_authors,
    ...
    companion object {
        fun create(
            ...
            onFavClick: (Int, Boolean) -> Unit
                ...
                SearchViewHolder {
            val itemBinding = BookScreenBookGutenbergSearchGutenbergEntryBinding
                .inflate(LayoutInflater.from(parent.context), parent, false)
            return SearchViewHolder(itemBinding, onItemClick, onFavClick)
        }
    }
