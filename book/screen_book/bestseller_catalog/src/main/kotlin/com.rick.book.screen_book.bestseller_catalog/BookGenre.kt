...
enum class BookGenre(val listName: String, val iconRes: Int = -1) {
    FICTION("hardcover-fiction", R.drawable.book_screen_book_bestseller_catalog_category_fiction),
    NONFICTION("hardcover-nonfiction", R.drawable.book_screen_book_bestseller_catalog_category_nonfiction),
