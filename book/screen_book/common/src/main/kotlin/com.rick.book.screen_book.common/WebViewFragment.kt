...
import com.rick.book.screen_book.common.databinding.BookScreenBookCommonWebViewFragmentBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class WebViewFragment : Fragment() {
    private var _binding: BookScreenBookCommonWebViewFragmentBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedElementEnterTransition = MaterialContainerTransform().apply {
            ...
            duration = resources.getInteger(R.integer.book_screen_book_common_motion_duration_long)
                .toLong()
    ...
    override fun onCreateView(
        ...
        _binding = BookScreenBookCommonWebViewFragmentBinding.inflate(inflater, container, false)
