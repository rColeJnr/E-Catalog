...
import com.rick.data.network_book.retrofit.GutenbergRetrofitNetworkApi.Companion.GUTENBERG_BASE_URL
...
internal class GutenbergRetrofitNetwork @Inject constructor() : GutenbergNetworkDataSource {
    ...
    override suspend fun searchBook(query: String): GutenbergResponse = networkApi.searchBook(query)
}