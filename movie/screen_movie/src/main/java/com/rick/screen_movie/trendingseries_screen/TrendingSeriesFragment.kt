...
//        }
    ...
    private fun onSeriesClick(view: View, series: UserTrendingSeries) {
        // TODO redo animations
        val action = TrendingSeriesFragmentDirections
        ...
        return when (item.itemId) {
            R.id.search_imdb -> {
                ...
                navController.navigate(
                    TrendingSeriesFragmentDirections.actionTvSeriesFragmentToSeriesSearchFragment()
                )
                true
            }
//            R.id.fav_imdb -> {
