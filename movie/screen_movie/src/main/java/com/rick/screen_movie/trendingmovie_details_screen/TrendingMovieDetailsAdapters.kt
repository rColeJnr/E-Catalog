...
class SimilarDetailsAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private val diffUtil =
        object : DiffUtil.ItemCallback<com.rick.data.model_movie.tmdb.Similar>() {
            override fun areItemsTheSame(
                oldItem: com.rick.data.model_movie.tmdb.Similar,
                newItem: com.rick.data.model_movie.tmdb.Similar
            ): Boolean {
...
class SimilarsViewHolder(binding: SimilarEntryBinding) :
    ...
    private lateinit var similar: com.rick.data.model_movie.tmdb.Similar

    fun bind(similar: com.rick.data.model_movie.tmdb.Similar) {
