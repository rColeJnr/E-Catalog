...
class SeriesSimilarDetailsAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return SeriesSimilarsViewHolder.create(parent)
    }
...
class SeriesSimilarsViewHolder(binding: MovieScreenMovieTrendingSeriesDetailsSimilarEntryBinding) :
    ...
    companion object {
        fun create(parent: ViewGroup): SeriesSimilarsViewHolder {
            val itemBinding = MovieScreenMovieTrendingSeriesDetailsSimilarEntryBinding
                .inflate(LayoutInflater.from(parent.context), parent, false)
            return SeriesSimilarsViewHolder(itemBinding)
        }
    }
}
