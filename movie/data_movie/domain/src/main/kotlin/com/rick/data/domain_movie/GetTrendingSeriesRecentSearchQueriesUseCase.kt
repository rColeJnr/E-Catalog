 ...
 */
class GetTrendingSeriesRecentSearchQueriesUseCase @Inject constructor(
    private val recentSearchRepository: TrendingSeriesRecentSearchRepository,
) {
    operator fun invoke(limit: Int = 10): Flow<List<TmdbRecentSearchQuery>> =
        recentSearchRepository.getTrendingSeriesRecentSearchQueries(limit)
}
